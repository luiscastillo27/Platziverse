...
test.serial('Setup', t => {
  ...
  t.true(_rec2._expr(_rec2._capt(_rec2._capt(_rec2._capt(AgentStub, 'arguments/0/object/object').belongsTo, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(AgentStub.belongsTo.called, \'AgentModel.belongsTo was executed\')',
    filepath: 'tests/agent-test.js',
    line: 37,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"belongsTo","range":[17,26]},"computed":false,"range":[7,26]},"property":{"type":"Identifier","name":"called","range":[27,33]},"computed":false,"range":[7,33]},{"type":"StringLiteral","value":"AgentModel.belongsTo was executed","range":[35,70]}],"range":[0,71]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"belongsTo","range":[17,26]},{"type":{"label":"."},"range":[26,27]},{"type":{"label":"name"},"value":"called","range":[27,33]},{"type":{"label":","},"range":[33,34]},{"type":{"label":"string"},"value":"AgentModel.belongsTo was executed","range":[35,70]},{"type":{"label":")"},"range":[70,71]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'AgentModel.belongsTo was executed');
});

test('Agent', t => {
  var _rec3 = new _powerAssertRecorder();

  t.truthy(_rec3._expr(_rec3._capt(_rec3._capt(db, 'arguments/0/object').Agent, 'arguments/0'), {
    content: 't.truthy(db.Agent, \'Agent sure exit\')',
    filepath: 'tests/agent-test.js',
    line: 41,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"truthy","range":[2,8]},"computed":false,"range":[0,8]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"db","range":[9,11]},"property":{"type":"Identifier","name":"Agent","range":[12,17]},"computed":false,"range":[9,17]},{"type":"StringLiteral","value":"Agent sure exit","range":[19,36]}],"range":[0,37]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"truthy","range":[2,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"db","range":[9,11]},{"type":{"label":"."},"range":[11,12]},{"type":{"label":"name"},"value":"Agent","range":[12,17]},{"type":{"label":","},"range":[17,18]},{"type":{"label":"string"},"value":"Agent sure exit","range":[19,36]},{"type":{"label":")"},"range":[36,37]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'Agent sure exit');
});
//# sourceMappingURL=/Users/luiscastillo/Sites/Platziverse/platziverse-db/node_modules/.cache/ava/8629c206d789506442b932fd74b15dc8.js.map